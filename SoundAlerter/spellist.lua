...
function SoundAlerter:GetSpellList ()
	return {
		...
		castStart = {
			...
			--general
			[635]   = otherP.bigH.."bigHeal",	--Holy Light rank 1
			[639]   = otherP.bigH.."bigHeal",	--Holy Light rank 2
			[647]   = otherP.bigH.."bigHeal",	--Holy Light rank 3
			[1026]  = otherP.bigH.."bigHeal",	--Holy Light rank 4
			[1042]  = otherP.bigH.."bigHeal",	--Holy Light rank 5
			[3472]  = otherP.bigH.."bigHeal",	--Holy Light rank 6
			[10328] = otherP.bigH.."bigHeal",	--Holy Light rank 7
			[10329] = otherP.bigH.."bigHeal",	--Holy Light rank 8
			[25292] = otherP.bigH.."bigHeal",	--Holy Light rank 9
			[27135] = otherP.bigH.."bigHeal",	--Holy Light rank 10
			[27136] = otherP.bigH.."bigHeal",	--Holy Light rank 11
			[48782] = otherP.bigH.."bigHeal",	--Holy Light rank 12
			[2054]  = otherP.bigH.."bigHeal",		--Heal rank 1
			[2055]  = otherP.bigH.."bigHeal",		--Heal rank 2
			[6063]  = otherP.bigH.."bigHeal",		--Heal rank 3
			[6064]  = otherP.bigH.."bigHeal",		--Heal rank 4
			[2060]  = otherP.bigH.."bigHeal",		--Greater Heal rank 1
			[332]   = otherP.bigH.."bigHeal",	--Healing Wave rank 2
			[547]   = otherP.bigH.."bigHeal",	--Healing Wave rank 3
			[913]   = otherP.bigH.."bigHeal",	--Healing Wave rank 4
			[939]   = otherP.bigH.."bigHeal",	--Healing Wave rank 5
			[959]   = otherP.bigH.."bigHeal",	--Healing Wave rank 6
			[8005]  = otherP.bigH.."bigHeal",	--Healing Wave rank 7
			[10395] = otherP.bigH.."bigHeal",	--Healing Wave rank 8
			[10396] = otherP.bigH.."bigHeal",	--Healing Wave rank 9
			[25357] = otherP.bigH.."bigHeal",	--Healing Wave rank 10
			[25391] = otherP.bigH.."bigHeal",	--Healing Wave rank 11
			[25396] = otherP.bigH.."bigHeal",	--Healing Wave rank 12
			[49272] = otherP.bigH.."bigHeal",	--Healing Wave rank 13
			[49273] = otherP.bigH.."bigHeal",	--Healing Wave rank 14
			--Druid
			--Restauration
			[5185]  = otherP.bigH.."bigHeal",		--Healing Touch rank 1
			[5186]  = otherP.bigH.."bigHeal",		--Healing Touch rank 2
			[5187]  = otherP.bigH.."bigHeal",		--Healing Touch rank 3
			[5188]  = otherP.bigH.."bigHeal",		--Healing Touch rank 4
			[5189]  = otherP.bigH.."bigHeal",		--Healing Touch rank 5
			[6778]  = otherP.bigH.."bigHeal",		--Healing Touch rank 6
			[8903]  = otherP.bigH.."bigHeal",		--Healing Touch rank 7
			[9758]  = otherP.bigH.."bigHeal",		--Healing Touch rank 8
			[9888]  = otherP.bigH.."bigHeal",		--Healing Touch rank 9
			[9889]  = otherP.bigH.."bigHeal",		--Healing Touch rank 10
			[25297] = otherP.bigH.."bigHeal",		--Healing Touch rank 11
			[26978] = otherP.bigH.."bigHeal",		--Healing Touch rank 12
			[26979] = otherP.bigH.."bigHeal",		--Healing Touch rank 13
			[48377] = otherP.bigH.."bigHeal",		--Healing Touch rank 14
			[48378] = otherP.bigH.."bigHeal",		--Healing Touch rank 15
			[50464] = otherP.bigH.."bigHeal",		--Nourish
			--
			[2006]  = otherP.res.."resurrection",	--Resurrection (priest) rank 1
			[2010]  = otherP.res.."resurrection",	--Resurrection (priest) rank 2
			[10880] = otherP.res.."resurrection",	--Resurrection (priest) rank 3
			[10881] = otherP.res.."resurrection",	--Resurrection (priest) rank 4
			[20770] = otherP.res.."resurrection",	--Resurrection (priest) rank 5
			[25435] = otherP.res.."resurrection",	--Resurrection (priest) rank 6
			[48171] = otherP.res.."resurrection",	--Resurrection (priest) rank 7
			[7328]  = otherP.res.."resurrection",	--Redemption rank 1
			[10322] = otherP.res.."resurrection",	--Redemption rank 2
			[10324] = otherP.res.."resurrection",	--Redemption rank 3
			[20772] = otherP.res.."resurrection",	--Redemption rank 4
			[20773] = otherP.res.."resurrection",	--Redemption rank 5
			[48949] = otherP.res.."resurrection",	--Redemption rank 6
			[48950] = otherP.res.."resurrection",	--Redemption rank 7
			[2008]  = otherP.res.."resurrection",	--Ancestral Spirit rank 1
			[20609] = otherP.res.."resurrection",	--Ancestral Spirit rank 2
			[50769] = otherP.res.."resurrection",	--Revive rank 1
			[50768] = otherP.res.."resurrection",	--Revive rank 2
			[50767] = otherP.res.."resurrection",	--Revive rank 3
			[50766] = otherP.res.."resurrection",	--Revive rank 4
			[50765] = otherP.res.."resurrection",	--Revive rank 5
			[50764] = otherP.res.."resurrection",	--Revive rank 6
			[50763] = otherP.res.."resurrection",	--Revive rank 7
		...
		enemyDebuffs = {
			[2094]  = enemyP.dbf.."Enemyblinded", --works
			[51724] = enemyP.dbf.."Enemysapped", --works
			[12826] = enemyP.dbf.."EnemyPollied",
			[118]   = enemyP.dbf.."EnemyPollied",
			[33786] = enemyP.dbf.."EnemyCycloned",--menu
			[51514] = enemyP.dbf.."EnemyHexxed",
		},
		-- Enemy SPELL_AURA_REMOVED CC
		enemyDebuffdown = {
			[2094]  = enemyP.dbfD.."blinddown", --works
			[51724] = enemyP.dbfD.."sapdown", --works
			[118]   = enemyP.dbfD.."polydown",
			[12826] = enemyP.dbfD.."polydown",
			[33786] = enemyP.dbfD.."cyclonedown", --menu
			[51514] = enemyP.dbfD.."hexdown",
		},

		-- Friend SPELL_COUNTERED
		interruptFriend = {
			[2139]  = friendP.intr.."friendcountered",
			[50613] = friendP.intr.."friendcountered",
			[1766]  = friendP.intr.."friendcountered",
			[57994] = friendP.intr.."friendcountered",
			[72]    = friendP.intr.."friendcountered",
			[47528] = friendP.intr.."friendcountered",
		},
		-- Friend - ENemy SPELL_CASTING_START CC -> Party
		friendCCs = {
			[33786] = friendP.dbfCst.."cyclonefriend",
			[51514] = friendP.dbfCst.."hexfriend",
			[12826] = friendP.dbfCst.."polyfriend",
			[118]   = friendP.dbfCst.."polyfriend",
			[28272] = friendP.dbfCst.."polyfriend",
			[61305] = friendP.dbfCst.."polyfriend",
			[61721] = friendP.dbfCst.."polyfriend",
			[61025] = friendP.dbfCst.."polyfriend",
			[61780] = friendP.dbfCst.."polyfriend",
			[28271] = friendP.dbfCst.."polyfriend",
			[6215]  = friendP.dbfCst.."fearfriend",
		},
		-- Friend - Enemy SPELL_CASTING_SUCCESS CC -> Party
		friendCCSuccess = {
			[14309] = friendP.dbfScs.."friendfrozen",
			[2094]  = friendP.dbfScs.."blindfriend",
			[5246]  = friendP.dbfScs.."friendfeared", --intimidating shout
			[51724] = friendP.dbfScs.."friendsapped",
			[33786] = friendP.dbfScs.."friendcycloned",
			[10308] = friendP.dbfScs.."friendstunned",
			[2139]  = friendP.dbfScs.."friendcountered",
			[51514] = friendP.dbfScs.."friendhexxed",
			[118]   = friendP.dbfScs.."friendpoly",
			[12826] = friendP.dbfScs.."friendpoly",
			[6215]  = friendP.dbfScs.."friendfeared",
			[10890] = friendP.dbfScs.."friendfeared",
			[17928] = friendP.dbfScs.."friendfeared",
		},
		-- Party SPELL_CASTING_SUCCESS CC -> Enemy
		friendCCenemy = {
			[2094]  = enemyP.dbf.."enemyblinded",
			[51724] = enemyP.dbf.."enemysapped",
			[51514] = enemyP.dbf.."enemyhexxed",
			[12826] = enemyP.dbf.."enemypollied",
			[118]   = enemyP.dbf.."enemypollied",
			[33786] = enemyP.dbf.."enemycycloned",
		},
		-- Enemy SPELL_AURA_REMOVED CC
		enemyDebuffdownAP = {
			[2094]  = enemyP.dbfD.."Blinddown",
			[51724] = enemyP.dbfD.."Sapdown",
			[51514] = enemyP.dbfD.."Hexdown",
			[12826] = enemyP.dbfD.."Polydown",
			[118]   = enemyP.dbfD.."Polydown",
			[33786] = enemyP.dbfD.."CycloneDown",
		},
		-- SELF
		selfDebuff = {
			[33786] = selfP.."Cyclone",
			[51514] = selfP.."Hex",
			[12826] = selfP.."Polymorph",
			[118]   = selfP.."Polymorph",
			[28272] = selfP.."Polymorph",
			[61305] = selfP.."Polymorph",
			[61721] = selfP.."Polymorph",
			[61025] = selfP.."Polymorph",
			[61780] = selfP.."Polymorph",
			[28271] = selfP.."Polymorph",
			[6215]  = selfP.."Fear",
			[60192] = selfP.."Freezingtrap", --double check
			[14309] = selfP.."Freezingtrap", --freezing trap effect
			[13810] = selfP.."Frosttrap", --frost trap aura
			[13809] = selfP.."Frosttrap", --frost trap aura
			[14311] = selfP.."Freezingtrap",
			[19503] = selfP.."scattershot", -- NEW: Scatter Shot
			[1499]  = selfP.."Frosttrap",
			[5246]  = selfP.."Fear3", --intimidating shout
			[17928] = selfP.."Fear2", --Howl of Terror
			[2094]  = selfP.."Blind",
			[51724] = selfP.."Sap",
			[11297] = selfP.."Sap",
			[6770]  = selfP.."Sap",
			[10308] = selfP.."Hammerofjustice",
			[10890] = selfP.."Fear4", -- Psychic Scream
			[47860] = selfP.."Deathcoil",
			[5138]  = selfP.."drainMana",
			[44572] = selfP.."DeepFreeze",
			[20066] = selfP.."Repentance",
			[34490] = selfP.."Silencingshot",
			[19434] = selfP.."Aimedshot", --Aimed Shot rank 1
			[49050] = selfP.."Aimedshot", --Aimed Shot rank 9
			[47476] = selfP.."Strangulate",
			[51722] = selfP.."Disarm2", --dismantle
			[61606] = selfP.."Markofblood",
			[19386] = selfP.."wyvernSting",
			[49010] = selfP.."wyvernSting",
			[6358]  = selfP.."seduction",
		},
	}
end
